...
PosResult BinarySearchHybrid::predecessor_seeded(const uint64_t* keys, size_t p, size_t q, const uint64_t x) const {
...
PosResult BinarySearchHybrid::predecessor(const uint64_t* keys, const size_t num, const uint64_t x) const {
